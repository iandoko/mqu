...
<html>
<head>
    <title>Konfirmasi Pembayaran Order</title>
    ...
    <table width="80%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td align="left" width="95%" style="font: 13px/18px Arial, Helvetica, sans-serif;">
                Mohon dicek konfirmasi berikut. <br/>
                <br/>
                <br/>
                ...
                <br/>
                <br/>
                Approval pembayaran dapat dilakukan melalui user admin.
                ...
                <br/>
                <br/>
                Sistem App <strong>{sitename}</strong><br/>
