        ...
        <div class="profile-content">
            <div class="row">
                <div class="col-md-12">
                                ...
                                <table class="table table-hover table-light">
                                       ...
                                       <td>
                                        ...
                                        <td colspan="1">
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input class="form-control input-large" type="text" placeholder="Nama Lengkap" value="<?php echo $nama_lengkap;?>" name="nama_lengkap">
								                </div>
                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row fileupload-buttonbar">
                                                            ...
                                                            <span class="btn green fileinput-button"><i class="fa fa-plus"></i>
                                                                <span>Ganti Photo... </span><input name="pas_foto" type="file" accept="image/*" onchange="loadFile(event)">
                                                            </span>
                                                        <div class="col-md-4">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1">
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input class="form-control input-large" type="text" placeholder="Nomor KTP" value="<?php echo $nomor_ktp;?>" name="nomor_ktp">
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input class="form-control input-small" type="text" placeholder="Tempat Lahir" value="<?php echo $tempat_lahir;?>" name="tempat_lahir">
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="col-md-3">
                                                    <input class="form-control form-control-inline input-small date-picker" type="text" placeholder="dd-mm-yyyy" size="16" value="<?php echo date('d-m-Y',strtotime($tanggal_lahir));?>" name="tanggal_lahir">
										        </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <input class="form-control input-xxlarge"  type="text" placeholder="Alamat" value="<?php echo $alamat;?>" name="alamat">
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input class="form-control input-small" type="text" placeholder="Nomer Rumah" value="<?php echo $no;?>" name="no">
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input class="form-control input-small" type="text" placeholder="RT" value="<?php echo $rt;?>" name="rt">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input class="form-control input-small" type="text" placeholder="RW" value="<?php echo $rw;?>" name="rw">
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input class="form-control input-medium" type="text" placeholder="Kabupaten / Kota" value="<?php echo $kabupaten_kota;?>" name="kabupaten_kota">
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input class="form-control input-medium" type="text" placeholder="Propinsi" value="<?php echo $propinsi;?>" name="propinsi">
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input class="form-control input-medium" type="text" placeholder="Kode Pos" value="<?php echo $kodepos;?>" name="kodepos">
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    <input class="form-control input-large" type="text" placeholder="Nomer Handphone" value="<?php echo $no_handphone;?>" name="no_handphone">
                                                </div>
                                            </div>
                    ...
                    <!-- END PORTLET -->
                    <input name="user_profile_uid" type="hidden" value="<?php echo $user_profile_uid;?>">
                   <input type="submit" value="update" name="update" class="btn btn-lg blue hidden-print margin-bottom-5" href="<?php echo base_url();?>member/edit_profile/<?php echo $user_profile_uid;?>">


                    <a class="btn btn-lg red hidden-print margin-bottom-5" href="<?php echo base_url();?>member/detail/<?php echo $user_profile_uid;?>">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text"
                                   placeholder="Alamat Tinggal" value="<?php echo $alamat; ?>"
                                   name="alamat">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text"
                               placeholder="Kode Pos" value="<?php echo $kodepos; ?>"
                               name="kodepos">
