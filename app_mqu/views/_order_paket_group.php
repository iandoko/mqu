        ...
        <div class="portlet light" id="form_wizard_1">
            <div class="portlet-title">
                <div class="caption">
								...
								<i class="fa fa-cart"></i><span class="step-title">Step 1 dari 4 </span>
								</span>
                </div>
            </div>
                        ...
                        <div class="form-body">
                            <ul class="nav nav-pills nav-justified steps">
                                <li>
                                    <a href="#tab1" data-toggle="tab" class="step">
												...
												1 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Pilih Paket </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#tab2" data-toggle="tab" class="step">
												...
												2 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Pilih Group </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#tab3" data-toggle="tab" class="step active">
												...
												3 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Order Detail </span>
                                    </a>
                                </li>
                                <li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="alert alert-success display-none">
                                    <button class="close" data-dismiss="alert"></button>
                                    Form Anda sudah tervalidasi dengan benar!
                                </div>
                                <div class="tab-pane active" id="tab1">
                                    <h3 class="block">Pilih Paket dan tentukan banyak user dalam group</h3>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Jumlah User Dalam Group <span class="required">
													* </span>
                                        </label>
                                        <div class="col-md-4">
                                            <input type="password" class="form-control" name="password" id="submit_form_password"/>
														<span class="help-block">
														minimum 2 user , maksimum 7 user. </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab2">
                                    <h3 class="block">Pilih Group atau buat group baru</h3>
                                    <div class="form-group">
